...
<template>
  <div class="accordion mb-3" id="jobDetailAccordion">
                ...
                <tbody>
                  ...
                  >
                    <td>
                      ...
                      <span
                        v-show="statusHistory.status == 1"
                        class="text-success"
                        >&#x25cf;</span
                      >
                    </td>
                    <td>
                      {{ statusHistory.employee_statuses.title }}
                    </td>
    ...
    <!-- Compensation -->
    <div class="accordion-item mb-3">
      <h2 class="accordion-header" id="panelsStayOpen-headingCompensation">
        <button
          class="accordion-button p-2"
          type="button"
          data-coreui-toggle="collapse"
            ...
            <div class="col-12">
              <table class="table table-hover" style="border: 1px solid #ddd">
                ...
                <tbody>
                  ...
                  >
                    <td colspan="6">No compensation history found.</td>
                  </tr>
                  <tr
                    v-else
                    v-for="(
                  ...
                  >
                    <td>
                      ...
                      <span
                        v-show="compensationHistory.status == 1"
                        class="text-success"
                        >&#x25cf;</span
                      >
                    </td>
                    ...
                    <td>
                      {{ compensationHistory.pay_types.title }}
                    </td>
                    <td>
                ...
                <tbody>
                  ...
                  >
                    <td>
                      ...
                      <span v-show="jobHistory.status == 1" class="text-success"
                        >&#x25cf;</span
                      >
                    </td>
                    <td>
