...
const work_status =
  props.employee.emp_curr_status == null
    ? "---"
    : props.employee.emp_curr_status.employee_statuses.title;

const work_type =
  props.employee.emp_curr_type == null
    ? "---"
    : props.employee.emp_curr_type.employee_types.title;

const work_department =
  props.employee.emp_curr_work == null
    ? "---"
...
const work_location =
  props.employee.emp_curr_work == null
    ? "---"
    : props.employee.emp_curr_work.locations.title;
</script>
                        ...
                        <div class="col-12">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-if="
                                            employee.educ_backgrounds.length < 1
                                        "
                                    >
                                        <td colspan="5">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr v-if="employee.dependents.length < 1">
                                        <td colspan="5">
                                            No dependent information found.
                                        </td>
                                    </tr>
                                    <tr
                                        v-else
